...
class InvoiceControllerTest {
    ...
    void getInvoiceWithFilter() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/invoice?page=1&&size=2&&startDate=08-12-2022&&endDate=13-12-2022")
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    void getInvoiceById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/invoice" + "/" + getInvoice.getInvoiceID())
    ...
    void getInvoiceByDriverID() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/invoice/byDriverID?driverID=2&&page=1&&size=1&&startDate=08-12-2022&&endDate=13-12-2022")
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
